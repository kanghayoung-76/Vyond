...
#define RUNTIME_SYSCALL_GET_SHM_EIDS        1012  /* query SHM channel EID list before mapping */
#define RUNTIME_SYSCALL_MAP_UTM             1013  /* get pre-mapped UTM base VA and size */
